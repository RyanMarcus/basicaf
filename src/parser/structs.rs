...
#[derive(Debug, Clone)]
pub enum DBStmt {
    DEF { funcname: String, varname: String, expr: DBExpr },
    ...
    RETURN,
    GOTO { lineno: u32},
    IF {expr1: DBExpr, op: String, expr2: DBExpr,
        lineno: u32},
    LET { target: DBLetTarget, expr: DBExpr },
    PRINT { seq: Vec<DBExpr> },
    DATA {seq: Vec<f32> },
    READ {varnames: Vec<DBLetTarget>},
    REM
}
